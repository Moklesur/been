...
function themetim_typography_color($color) {
     ...
     * General Section
     */
    $body_text_color = get_theme_mod( 'bg_text_color', '#fff' );
    ...
    $link_hover_color = get_theme_mod( 'link_hover_color', '#f0123f' );
     ...
     * Default Button
     */
    $btn_default_bg = get_theme_mod( 'btn_default_bg', '#f0123f' );
    $btn_default_text = get_theme_mod( 'btn_default_text', '#fff' );
    $btn_default_border = get_theme_mod( 'btn_default_border', '#f0123f' );
    ...
    $btn_primary_bg_hover = get_theme_mod( 'btn_primary_bg_hover', '#f0123f' );
    $btn_primary_text_hover = get_theme_mod( 'btn_primary_text_hover', '#fff' );
    $btn_primary_border_hover = get_theme_mod( 'btn_primary_border_hover', '#f0123f' );
     ...
     * Success Button
     */
    $btn_success_bg = get_theme_mod( 'btn_success_bg', '#f0123f' );
    $btn_success_text = get_theme_mod( 'btn_success_text', '#fff' );
    $btn_success_border = get_theme_mod( 'btn_success_border', '#f0123f' );
